...
/**
 * Created by JurigXiaomi on 4/19/2018.
 */
...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject baseJsonData = new JSONObject(SAMPLE_JSON_RESPONSE);

            JSONArray earthquakeArray = baseJsonData.getJSONArray("features");
            ...
            for (int i = 0; i < earthquakeArray.length(); i++){
                ...
                // add earthquakes from ArrayList<Earthquake>: look line 43
                earthquakeArrayList.add(earthquakeObject);
            }
